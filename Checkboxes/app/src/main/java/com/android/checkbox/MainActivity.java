...
public class MainActivity extends AppCompatActivity {
    ...
    public void toastMessage(View view) {
        selectToppings((CheckBox) findViewById(R.id.check_syrup), getString(R.string.chocolate_syrup));
        ...
        selectToppings((CheckBox) findViewById(R.id.check_oreo), getString(R.string.orio_cookie_crumbles));
